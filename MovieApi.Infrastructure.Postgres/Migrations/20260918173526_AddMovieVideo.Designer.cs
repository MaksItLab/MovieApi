...
namespace MovieApi.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20260918173526_AddMovieVideo")]
    partial class AddMovieVideo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.MoviePoster", b =>
                {
                    b.Property<Guid>("MovieId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.MovieVideo", b =>
                {
                    b.Property<Guid>("MovieId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.MoviePoster", b =>
                {
                    b.HasOne("MovieApi.Domain.Entities.Movie", "Movie")
                        .WithOne("Poster")
                        .HasForeignKey("MovieApi.Domain.Entities.MoviePoster", "MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.MovieVideo", b =>
                {
                    b.HasOne("MovieApi.Domain.Entities.Movie", "Movie")
                        .WithOne("Video")
                        .HasForeignKey("MovieApi.Domain.Entities.MovieVideo", "MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
